...
The inputs should still be provided to the program by replacing the values at addresses `1` and `2`, just like before. In this program, the value placed in address `1`. Each of the two input values will be between `0` and `99`, inclusive.
